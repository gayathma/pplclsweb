joint.shapes.org.Member.prototype.markup = [
    ...
    '<a href="http://localhost:8000/dash/profile-apparel/1" class="btn edit"><rect class="edit"/><text class="profile">View</text></a>',
    '</g>'
].join('');
...
var members = [
    member('Project Manager', 'Ian Hart', '/images/male.png', '#7c68fc').position(100,350),
    member('Cutting Officer', 'Alan Hart', '/images/male.png', '#fe854f'),
    member('Sewing Floor Officer', 'Dominic Coleman', '/images/male.png', '#fe854f'),
    member('Finishing Officer', 'Jake Hudson', '/images/male.png', '#fe854f'),
    member('Sewer', 'Joe Green', '/images/male.png', '#31d0c6'),
    member('Sewer', 'Andrew Bell', '/images/male.png', '#31d0c6'),
    member('Spreader', 'Alexander Johnston', '/images/male.png', '#feb663'),
    member('Cutter' , 'Soniya May', '/images/female.png', '#feb663'),
    member('Button Maker', 'Lucas Powell', '/images/male.png', '#feb663'),
    member('Inline', 'Nell Willkings', '/images/male.png', '#feb663')
];

var connections = [
    link(members[0], members[1]),
    link(members[0], members[2]),
    link(members[0], members[3]),
    link(members[2], members[4]),
    link(members[2], members[5]),
    link(members[1], members[6]),
    link(members[1], members[7]),
    link(members[3], members[8]),
    link(members[3], members[9])
];
...
paperScroller.$el.css({ width: '100%', height: '100%' }).appendTo('#paper_apparel');
