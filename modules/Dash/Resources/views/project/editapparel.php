...
<?php if (is_null($project)): ?>
    <div class="row">
        <div class="col-sm-12">
            <h4 class="page-title"><?php echo  Lang::get('custom.add_new_project');?></h4>
            <ol class="breadcrumb">
                <li>
                ...
                <li class="active">
                    <?php echo  Lang::get('custom.add_new_project');?>
                </li>
            </ol>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group m-b-20">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="<?php echo  Lang::get('custom.example');?> : CRM Project" value="<?php echo (!is_null($project) ? $project->name : ''); ?>">
                                </div>
                            </div>
