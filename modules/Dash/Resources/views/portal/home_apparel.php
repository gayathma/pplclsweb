        ...
        <table style="position:absolute;top:50px;right:10px;;font-size:smaller;color:#545454">
          <tbody>
            ...
            <tr>
              ...
              <td class="legendLabel">
                <div style="font-size:13px;">&nbsp;Overtime</div>
              </td>
            </tr>
            <tr>
              <td class="legendColorBox">
		...
		<div class="card-box">
			...
			<div class="text-center">
				<ul class="list-inline chart-detail-list">
					<li>
						<h5 style="color: #f9c851;"><i class="fa fa-circle m-r-5"></i>Ian Hart</h5>
					</li>
					<li>
						<h5 style="color: #35b8e0;"><i class="fa fa-circle m-r-5"></i>Dominic Coleman</h5>
					</li>
				</ul>
			</div>
...
new Chartist.Bar('#stacked-bar-chart', {
  labels: ['Softlogic T-shirt', 'Cinec Uniform', 'SL Youth T-shirt', 'SL Cricket Costume'],
  series: [
  [1800000, 1700000, 1800000, 1400000],
  [200000, 2000000, 500000, 200000],
  [160000, 290000, 510000, 600000]
  ]
}, {
  stackBars: true,
  axisY: {
  ...
  var MorrisCharts = function() {};
     ...
     MorrisCharts.prototype.createDonutChart = function(element, data, colors) {
      ...
      MorrisCharts.prototype.init = function() {
        ...
        var $donutData = [
        {label: "Not Engaged", value: 11},
        {label: "Actively Disengaged", value: 40},
        {label: "Engaged", value: 75}
        ];
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b'], ['Ian Hart', 'Dominic Coleman'],['#ffffff'],['#999999'], ['#f9c851', "#35b8e0"]);
