<div class="row">
	<div class="col-lg-3 col-md-6">
		<div class="card-box">
			...
			<h4 class="header-title m-t-0 m-b-30"><i class="zmdi zmdi-male-female m-r-5"></i> Upcoming Reminders</h4>
			...
			<ul class="list-group m-b-0 user-list">
				<li class="list-group-item">
					<a href="#" class="user-list-item">
						...
						<div class="user-desc">
							...
							<span class="desc">3 employees</span>
						</div>
					</a>
				</li>
				...
				<li class="list-group-item">
					<a href="#" class="user-list-item">
						...
						<div class="user-desc">
							...
							<span class="desc">6 employees</span>
						</div>
					</a>
				</li>
				...
				<li class="list-group-item">
					<a href="#" class="user-list-item">
						...
						<div class="user-desc">
							...
							<span class="desc">12 employees</span>
						</div>
					</a>
				</li>
				...
				<li class="list-group-item">
					<a href="#" class="user-list-item">
						...
						<div class="user-desc">
							...
							<span class="desc">20 employees</span>
						</div>
					</a>
				</li>
				...
				<li class="list-group-item">
					<a href="#" class="user-list-item">
						...
						<div class="user-desc">
							<span class="name">QA Engineer</span>
							<span class="desc">5 employees</span>
						</div>
					</a>
				</li>
			</ul>
	...
	<div class="col-lg-3 col-md-6">
		<div class="card-box widget-user">
			<div class="text-center">
				<h2 class="text-custom" data-plugin="counterup">46</h2>
	...
	<div class="col-lg-3 col-md-6">
		<div class="card-box widget-user">
			<div class="text-center">
				<h2 class="text-warning" data-plugin="counterup">5</h2>
				<h5>Number of Roles Detected</h5>
			</div>
		</div>
	</div>
	...
	<div class="col-lg-3 col-md-6">
		<div class="card-box widget-user">
			<div class="text-center">
				<h2 class="text-custom" data-plugin="counterup">12</h2>
	...
	<div class="col-lg-3 col-md-6">
		<div class="card-box">
			<h4 class="header-title m-t-0 m-b-30">Prediction Based On</h4>
			<p class="font-600 m-b-5">Linear Regression Algorithm <span class="text-primary pull-right">80%</span></p>
	...
	<div class="col-lg-3 col-md-6">
		<div class="card-box">
			<h4 class="header-title m-t-0 m-b-30">Prediction Based On</h4>
			<p class="font-600 m-b-5">Fuzzy Algorithm <span class="text-warning pull-right">65%</span></p>
	...
	<div class="col-lg-3 col-md-6">
		<div class="card-box">
			<h4 class="header-title m-t-0 m-b-30">Prediction Based On</h4>
			<p class="font-600 m-b-5">Hungarian Algorithm <span class="text-success pull-right">40%</span></p>
...
<!--
	<div class="col-lg-3 col-md-6">
		<div class="card-box">
			<h4 class="header-title m-t-0 m-b-30">Current Success Ratio</h4>
			<div class="widget-chart-1">
				...
				<div class="widget-detail-1">
					<h2 class="p-t-10 m-b-0" data-plugin="counterup"> 1020 </h2>
