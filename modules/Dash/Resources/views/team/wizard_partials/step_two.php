        ...
        <?php if (!empty($project)): ?>
                <tr>
                    ...
                    <td> 
                        <div class="row">
                            <div class="col-lg-12">
                                    <select class="select2 select2-multiple tech-multi required" multiple="multiple" multiple data-placeholder="Select">
...
// Select2
    ...
    function addRole(element) {
        ...
        if($(element).parent().parent().parent().find('#emp_count_'+$(job_role).val()).length == 1){
            ...
            $(element).parent().parent().parent().append('<div class="row"><div class="col-lg-6"><p class="text-muted">'+$(job_role).find("option:selected").text()+'</p></div><div class="col-lg-2"><span class="badge badge-success" id="emp_count_'+$(job_role).val()+'">'+employee_count+'</span><input type="hidden" value="'+employee_count+'"/><a href="javascript:;" class="remove" onclick="removeRole(this)"><i class="md md-close"></i></a></div></div>');
        }
    }
